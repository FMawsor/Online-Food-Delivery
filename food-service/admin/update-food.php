...
<tr>
    ...
    <td>
        ...
        //check whether category avialble or not
        if($count>0)
        {
                //category available
...
<tr>
    ...
    <?php 
        if(isset($_POST['submit']))
        {
            ...
            //check whether click button is clicked or not
            if(isset($_FILES['image']['name']))
            {
                    ...
                    if($image_name!= "")
                    {
                        ...
                        //rename the image
                        $ext = end(explode('.', $image_name)); //gets the extension of the file
            ...
            {
                    $image_name = $current_image; //default image when button is not click
            }
            //4.update the food in dbse
